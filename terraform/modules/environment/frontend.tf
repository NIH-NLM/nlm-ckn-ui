...
# Random secret for CloudFront -> ALB communication
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # Backend API behavior: forward to ALB
  ordered_cache_behavior {
    path_pattern           = "/arango_api/*"
...
resource "aws_acm_certificate" "cloudfront" {
  ...
  tags = merge(local.tags, { Name = "${local.name_prefix}-cloudfront-cert" })
}
